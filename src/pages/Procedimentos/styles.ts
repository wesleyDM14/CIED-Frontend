...
export const ProcedimentoContainer = styled.div`
    grid-area: main;
    display: block;
...
export const ProcedimentoHeader = styled.div`
    display: flex;
...
export const AddProcedimentoContainer = styled.div`
    display: flex;
...
export const AddProcedimentoButton = styled.button`
    display: flex;
    width: 180px;
    align-items: center;
    justify-content: center;
...
export const ProcedimentoListContainer = styled.div`
...
export const ProcedimentoListHeaderLabel = styled.h5`
    font-size: 14px;
`;
...
export const ProcedimentoValueContainer = styled.div`
    display: flex;
    align-items: center;
    flex-direction: row;
    overflow: hidden;
...
export const ProcedimentoValue = styled.a`
    font-size: 15px;
    font-weight: bold;
    color: ${colors.mainText};
...
export const ProcedimentoLabel = styled.p`
    font-size: 15px;
